export const WayofWork=()=>{
    return(
        <div>
            ...
            <h2>How it Works</h2>
            <p>1.Problem-Find the problem faced by common people</p>
            <p>2.Research-Find the Root cause of problem</p>
            <p>3.Solution-Provide Solutions using modern tools and technology</p>
            <h2>How we do it</h2>
            <p>
            Step 1-Research
            Step 2-Design
